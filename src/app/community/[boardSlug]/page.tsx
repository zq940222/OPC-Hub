  ...
  return (
    <main className="shell grid gap-6 py-8 md:py-12">
      <section className="flex flex-col gap-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm md:flex-row md:items-end md:justify-between md:p-8">
        <div>
          <p className="text-sm font-semibold text-teal-700">Board</p>
      ...
      <section className="grid gap-4">
        ...
        {board.posts.length === 0 ? <p className="rounded-lg border border-dashed border-slate-300 bg-white p-5 text-sm text-slate-500">No posts yet.</p> : null}
      </section>
    </main>
  );
}
